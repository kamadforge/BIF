...
def load_cervical():
    ...
    if 'g0' not in socket.gethostname() and 'p0' not in socket.gethostname():
        df = pd.read_csv("/home/kamil/Desktop/Dropbox/Current_research/privacy/DPDR/data/Cervical/kag_risk_factors_cervical_cancer.csv")
    else:
        df = pd.read_csv(
...
def load_isolet():
    ...
    print(socket.gethostname())
    if 'g0' not in socket.gethostname() and 'p0' not in socket.gethostname():
        data_features_npy = np.load('/home/kamil/Dropbox/Current_research/privacy/DPDR/data/Isolet/isolet_data.npy')
        data_target_npy = np.load('/home/kamil/Dropbox/Current_research/privacy/DPDR/data/Isolet/isolet_labels.npy')
    else:
        # (1) load data
...
def load_epileptic():
    ...
    if 'g0' not in socket.gethostname() and 'p0' not in socket.gethostname():
        data = pd.read_csv("/home/kamil/Desktop/Dropbox/Current_research/privacy/DPDR/data/Epileptic/data.csv")
    else:
        # (1) load data
...
def load_census():
    ...
    print(socket.gethostname())
    if 'g0' not in socket.gethostname() and 'p0' not in socket.gethostname():
        data = np.load("/home/kamil/Desktop/Dropbox/Current_research/privacy/DPDR/data/real/census/train.npy")
    else:
        data = np.load(
