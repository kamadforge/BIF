...
def get_mnist_data_loaders(use_cuda, batch_size, test_batch_size):
...
def main():
    ...
    train_loader, test_loader = get_mnist_data_loaders(use_cuda, args.batch_size, args.test_batch_size)
