...
ours_sigma100 = acc_ours[4,:]

random_dists = ['VIPS(sig=0)', 'VIPS(sig=1)', 'VIPS(sig=10)', 'VIPS(sig=50)', 'VIPS(sig=100)']
...
ax1.set_title('Bayesian Logistic regression with Adult data')
