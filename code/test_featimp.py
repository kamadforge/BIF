...
def main():
    ...
    LR_models = np.load('LR_models.npy')
    LR_sigma0 = LR_models[0,:]
    LR_sigma1 = LR_models[1,:]
    LR_sigma10 = LR_models[2,:]
    LR_sigma50 = LR_models[3,:]
    LR_sigma100 = LR_models[4,:]
    ...
    model = Model(input_dim=input_dim, LR_model=torch.Tensor(LR_sigma0), num_samps_for_switch=num_samps_for_switch)
