...
def parse_args():
  ...
  parser.add_argument('--lamda', help='inavse hyper-parameter lambda', default=.1, type=float)
...
def do_featimp_exp(ar):
  ...
  aggregate_global_importance(tr_selection_prob, f'fair_global_importance_trainset_{ar.clf_iter}.npy')
  aggregate_global_importance(ts_selection_prob, f'fair_global_importance_testset_{ar.clf_iter}.npy')
